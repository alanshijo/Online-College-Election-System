...
<h2>Voter details</h2>
<form method="post" action="search_voters.php">
  <select name="opts">
    <option disabled selected>-View by Batch-</option>
  <?php 
    include "db_conn.php";
       $s="SELECT * FROM batch";
...
<form method="post" action="viewvoters.php">
...
if (isset($_POST['delete'])) {
   ...
   if (isset($_POST['user'])) {
     foreach($_POST['user'] as $user){
      $query1="DELETE FROM voter where username='$user'";
...
if (isset($_POST['search'])) {
  $batch=$_POST['opts'];
  $q1 = "select * from voter where batch='$batch'";
