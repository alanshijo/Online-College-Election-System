...
<body>
    <a STYLE="text-decoration: none;display: inline-block;padding: 8px 16px;:hover {background-color: #ddd;color: #28bb60;}" href="index.php" class="previous round">&#8249;</a>
<h1 align = "center" > Voter Registration </h1>
<form METHOD = "POST" action = "voterregcnct.php" onsubmit = "email()">
<table align="center">
<div class="bo">
...
<label>Email id:</label><input type= "text" name = "email" id="ema" placeholder ="examaple@mail.com" required/></td></tr>
<label>UG / PG:</label>
 <select name = "pgug">
